...
open class YouTubePlayerView(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0):
    ...
    override fun dispatchTouchEvent(event: MotionEvent): Boolean {
        onTouchEvent?.onTouchReceived(event)
    ...
    interface OnTouchEvent {
        fun onTouchReceived(event: MotionEvent)
    }
}